...
//var count = -1;
		...
		function loadData() {
			...
			if(typeof(keywords)=="undefined"){
				K = {page:startNum,cat_id:cat_id};
			}else if((typeof(cat_id))=="undefined" && (typeof(keywords))!="undefined"){
				K = {page:startNum,keywords:keywords};
			}else{
				K = {page:startNum,cat_id:cat_id,keywords:keywords};
			}
			$.ajax({
				async : true,
				url : serverURL, // 跨域URL
		...
		function desplay(datas){
			//datas = '<li> <a href="fpmx.html"> <img src="images/ic_wast.png" alt=""> <h3>￥0.00</h3> <p>发票代码：<span class="text-no">11155653322</span></p> <p>发票号码：<span class="text-no">00001234</span></p> </a> <p class="desc-normal desc-wast"><span class="left-aside">开票日期：2013/5/17</span><span class="right-aside">开票员：01</span></p> </li><li> <a href="fpmx.html"> <img src="images/ic_wast.png" alt=""> <h3>￥0.00</h3> <p>发票代码：<span class="text-no">11155653322</span></p> <p>发票号码：<span class="text-no">00001234</span></p> </a> <p class="desc-normal desc-wast"><span class="left-aside">开票日期：2013/5/17</span><span class="right-aside">开票员：01</span></p> </li><li> <a href="fpmx.html"> <img src="images/ic_wast.png" alt=""> <h3>￥0.00</h3> <p>发票代码：<span class="text-no">11155653322</span></p> <p>发票号码：<span class="text-no">00001234</span></p> </a> <p class="desc-normal desc-wast"><span class="left-aside">开票日期：2013/5/17</span><span class="right-aside">开票员：01</span></p> </li>';
			if(datas!=null && datas!=""){
