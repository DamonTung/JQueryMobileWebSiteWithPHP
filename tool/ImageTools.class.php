...
class ImageTools{
    ...
    public static function thumb($dst,$save_path=NULL,$width=200,$height=200){
        ...
        //imagesavealpha($timg, true);//透明画布
        imagesavealpha($timg, false);
        //创建白色填充缩略画布
        //$white = imagecolorallocatealpha($timg,255,255,255,127);//127透明
        $black = imagecolorallocatealpha($timg,0,0,0,0);
        //填充缩略画布
        //imagefill($timg,0,0,$white);
        imagefill($timg,0,0,$black);
        //复制并缩略
